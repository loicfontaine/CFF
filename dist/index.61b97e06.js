...
})({"3S0vV":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "e28b398f61b97e06";
"use strict";
...
async function getStation() {
    let res;
    try {
        res = await fetch("http://transport.opendata.ch/v1/stationboard?station=Yverdon-les-bains&transportations=train&limit=10");
...
},{"./Train":"dU1ba","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"dU1ba":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class Train {
    ...
    display(contener) {
        if (this.departedHours < 10) this.departedHours = `0${this.departedHours}`;
        if (this.departedMinutes < 10) this.departedMinutes = `0${this.departedMinutes}`;
        const html = ` <article>
...
},{}]},["3S0vV","i4o3Y"], "i4o3Y", "parcelRequire94c2")

//# sourceMappingURL=index.61b97e06.js.map
